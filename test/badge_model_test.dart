...
void main() {
  ...
  group('toJson / fromJson Roundtrip', () {
    ...
    test('coverUrl bleibt bei Roundtrip erhalten', () {
      final original = _fullBadge();
      final withCover = original.copyWith(coverUrl: 'https://example.com/cover.jpg');
      final restored = MeetupBadge.fromJson(withCover.toJson());
