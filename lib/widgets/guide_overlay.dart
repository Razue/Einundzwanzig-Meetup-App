...
class _GuideSpotlightState extends State<_GuideSpotlight>
  ...
  String _resolveTitle(AppLocalizations l10n, String key) {
    final map = <String, String>{
      ...
      'guideSettingsProfileTitle': l10n.guideSettingsProfileTitle,
      ...
      'guideSettingsRestartTitle': l10n.guideSettingsRestartTitle,
      ...
      'guideEvBasicsTitle': l10n.guideEvBasicsTitle,
      'guideEvWhenWhereTitle': l10n.guideEvWhenWhereTitle,
      ...
      'guideWalletMapTitle': l10n.guideWalletMapTitle,
      'guideWalletViewTitle': l10n.guideWalletViewTitle,
      'guideCommunityPortalTitle': l10n.guideCommunityPortalTitle,
      'guideCommunityNewsTitle': l10n.guideCommunityNewsTitle,
      'guideCommunityFunTitle': l10n.guideCommunityFunTitle,
      'guideMyMeetupsListTitle': l10n.guideMyMeetupsListTitle,
      'guideMyMeetupsCreateTitle': l10n.guideMyMeetupsCreateTitle,
      'guideWotTabsTitle': l10n.guideWotTabsTitle,
      'guideWotRefreshTitle': l10n.guideWotRefreshTitle,
  ...
  String _resolveBody(AppLocalizations l10n, String key) {
    final map = <String, String>{
      ...
      'guideSettingsProfileBody': l10n.guideSettingsProfileBody,
      ...
      'guideSettingsRestartBody': l10n.guideSettingsRestartBody,
      ...
      'guideEvBasicsBody': l10n.guideEvBasicsBody,
      'guideEvWhenWhereBody': l10n.guideEvWhenWhereBody,
      ...
      'guideWalletMapBody': l10n.guideWalletMapBody,
      'guideWalletViewBody': l10n.guideWalletViewBody,
      'guideCommunityPortalBody': l10n.guideCommunityPortalBody,
      'guideCommunityNewsBody': l10n.guideCommunityNewsBody,
      'guideCommunityFunBody': l10n.guideCommunityFunBody,
      'guideMyMeetupsListBody': l10n.guideMyMeetupsListBody,
      'guideMyMeetupsCreateBody': l10n.guideMyMeetupsCreateBody,
      'guideWotTabsBody': l10n.guideWotTabsBody,
      'guideWotRefreshBody': l10n.guideWotRefreshBody,
