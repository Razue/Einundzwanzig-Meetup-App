...
class HomeScreenState extends State<HomeScreen> with TickerProviderStateMixin {
  ...
  Widget _tile({required Widget child, required Color accentColor, VoidCallback? onTap, double opacity = 0.06, IconData? watermark}) {
